...
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
CREDENTIALS_FILE = '/home/pi/CSC132_Final-main/AccurackVenv/Accurack1/credentials.json'
...
class Application(Frame):
    def __init__(self, master=None):
        ...
        Label3A = Label(Frame3, text = "Reminders", font = "Times 20 bold", bg = "aquamarine")
        Label3A.pack()
